  ...
  return (
    <div>
      <div className="mb-8 text-center">
        ...
        <h2 className="text-3xl font-bold text-[#FCFDFC] mb-2">Analysis Complete!</h2>
      ...
      <div className="bg-white rounded-lg border-2 border-slate-200 shadow-lg p-8 mb-8">
        <h3 className="text-2xl font-bold text-[#FCFDFC] mb-6 pb-4 border-b border-slate-200">
          Executive Summary
        </h3>

        {/* Client Info */}
        <div className="mb-6">
          <h4 className="text-lg font-semibold text-[#FCFDFC] mb-3">Client Information</h4>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="text-[#FCFDFC] opacity-80">Name:</span>
              <span className="ml-2 font-medium text-[#FCFDFC]">
                {clientData.firstName} {clientData.lastName}
              </span>
            </div>
            <div>
              <span className="text-[#FCFDFC] opacity-80">Age:</span>
              <span className="ml-2 font-medium text-[#FCFDFC]">{clientData.age}</span>
            </div>
            <div>
              <span className="text-[#FCFDFC] opacity-80">Target Retirement:</span>
              <span className="ml-2 font-medium text-[#FCFDFC]">{clientData.retirementAge}</span>
            </div>
            <div>
              <span className="text-[#FCFDFC] opacity-80">Years to Retirement:</span>
              <span className="ml-2 font-medium text-[#FCFDFC]">
        ...
        <div className="mb-6 pb-6 border-b border-slate-200">
          <h4 className="text-lg font-semibold text-[#FCFDFC] mb-3">Portfolio Summary</h4>
          <div className="bg-slate-50 p-4 rounded-lg">
            <div className="flex justify-between items-center mb-4">
              <span className="text-[#FCFDFC] opacity-80">Total Portfolio Value:</span>
              <span className="text-2xl font-bold text-[#FCFDFC]">
                ${totalValue.toLocaleString('en-US', { minimumFractionDigits: 2 })}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[#FCFDFC] opacity-80">Number of Holdings:</span>
              <span className="font-medium text-[#FCFDFC]">{portfolio.length}</span>
            </div>
          </div>
        </div>
        ...
        {/* Risk Assessment */}
        <div className="mb-6 pb-6 border-b border-slate-200">
          <h4 className="text-lg font-semibold text-[#FCFDFC] mb-3">Risk Profile</h4>
          <div className="flex items-center justify-between bg-blue-50 p-4 rounded-lg">
            <div>
              <div className="text-sm text-[#FCFDFC] opacity-80 mb-1">Behavioral Risk Tolerance</div>
        ...
        {/* Monte Carlo Results */}
        <div>
          <h4 className="text-lg font-semibold text-[#FCFDFC] mb-3">Projection Results</h4>
          <div className={`p-6 rounded-lg ${
            successRate >= 75 ? 'bg-green-50' : 'bg-orange-50'
          }`}>
            <div className="grid grid-cols-3 gap-6 mb-4">
              <div>
                <div className="text-sm text-[#FCFDFC] opacity-80 mb-1">Success Rate</div>
              ...
              <div>
                <div className="text-sm text-[#FCFDFC] opacity-80 mb-1">Median Outcome</div>
                <div className="text-2xl font-bold text-[#FCFDFC]">
                  ${(monteCarloResults.results.medianFinalValue / 1000000).toFixed(2)}M
                </div>
              </div>
              <div>
                <div className="text-sm text-[#FCFDFC] opacity-80 mb-1">Time Horizon</div>
                <div className="text-2xl font-bold text-[#FCFDFC]">
      ...
      <div className="bg-slate-50 p-6 rounded-lg border border-slate-200 mb-8">
        <h4 className="font-semibold text-[#FCFDFC] mb-2 text-sm">Important Disclosure</h4>
        <p className="text-xs text-[#FCFDFC] opacity-80 leading-relaxed">
